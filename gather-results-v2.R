# gather the results from the external storage-folder and compile into a database-style
# list + lookup -format.

library(tibble)

infiles <- dir("../../results_rds-v6/", full.names = TRUE)
...
soil_en <- cbind(c("mineraalimaa", "ojitettu suo", "ojittamaton suo"),
                 c("mineral", "drained peatl.", "undrained peatl.") )
